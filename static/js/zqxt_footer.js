...
if (window.innerWidth < 975 + 17) {
	document.getElementById("right-ad-1").style.minHeight="0";
}
}
...
function w_close_all_nav() {
	w_close_nav("tutorials");
	w_close_nav("references");
	w_close_nav("examples");
	w_close_nav("search");
	close_menu();
}
...
(function () {
	...
	if (window.addEventListener) { 
		document.getElementById("main").addEventListener("click", w_close_all_nav, true);
		m.addEventListener("click", w_close_all_nav, true);
		document.getElementById("right").addEventListener("click", w_close_all_nav, true);
	} else if (window.attachEvent) {                 
		document.getElementById("main").attachEvent("onclick", w_close_all_nav);
		m.attachEvent("onclick", w_close_all_nav);
		document.getElementById("right").attachEvent("onclick", w_close_all_nav);
	}
...
//打印
function printPage() {
	content=document.getElementById("main_content").innerHTML;
